...
@section('header_styles')
    <link href="{{ asset('assets/vendors/summernote/css/summernote.css') }}" rel="stylesheet" media="screen" />
                            ...
                            <div class="mail-compose">
                                <form method="post" role="form">
                                    <div class="mail-header">
                                        <h3>
                                            <img src=" {{ asset('assets/img/flaticons/1.png') }}" alt="icon" width="40" height="40">Compose Message</h3>
                                    </div>
...
@section('footer_scripts')
    <script  src="{{ asset('assets/vendors/summernote/js/summernote.min.js') }}"  type="text/javascript"></script>
        <script src="{{ asset('assets/js/custom_js/compose.js') }}" type="text/javascript"></script>
        @stop