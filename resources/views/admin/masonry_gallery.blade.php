...
@section('header_styles')
    <link href="{{ asset('assets/vendors/masonry-gallery/css/animated-masonry-gallery.css') }}" rel="stylesheet" type="text/css" />
...
@section('footer_scripts')
        <script src="{{ asset('assets/vendors/masonry-gallery/js/jquery.isotope.min.js') }}" type="text/javascript" ></script>
        <script src="{{ asset('assets/vendors/masonry-gallery/js/animated-masonry-gallery.js') }}" type="text/javascript" ></script>
