...
@section('header_styles')
    <link href="{{ asset('assets/vendors/animate/animate.min.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ asset('assets/css/custom_css/transitions.css') }}" rel="stylesheet" type="text/css"/>
    @stop
...
@section('footer_scripts')
        ...
        <script src="{{ asset('assets/js/custom_js/transitions.js') }}" type="text/javascript"></script>
        @stop