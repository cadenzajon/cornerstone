...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/x-editable/css/typeahead.js-bootstrap.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/custom_css/inlinedit.css') }}" rel="stylesheet" type="text/css" />
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/custom_js/demo-mock.js') }}" ></script>
    <script src="{{ asset('assets/js/custom_js/demo.js') }}" ></script>
    <script src="{{ asset('assets/js/custom_js/x-editable.js') }}"></script>
@stop