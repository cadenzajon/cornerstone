                ...
                <ul class="navigation">
                    ...
                    <li {{ (Request::is('admin/task') ? 'class=active' : '') }}>
                        <a href="{{ URL::to('admin/task') }}">
                            <i class="menu-icon fa fa-fw fa-list-ul"></i>
                            <span>Tasks</span>
                            <small class="badge">10</small>
                        </a>
                    </li>
                    <li class="menu-dropdown {{ (Request::is('admin/gallery') || Request::is('admin/masonry_gallery') || Request::is('admin/image_magnifier') || Request::is('admin/image_cropping') ? 'active' : '') }}">
                        <a href="#">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li {{ (Request::is('admin/image_cropping') ? 'class=active' : '') }}>
                                <a href="{{ URL::to('admin/image_cropping') }}">
                                    <i class="fa fa-fw fa-image"></i>
                                    Image Cropper
                                </a>
                            </li>
...
@if (!Request::is('admin/users') && !Request::is('admin/users/*') && !Request::is('admin/groups') && !Request::is('admin/groups/*')
     && !Request::is('admin/blog') && !Request::is('admin/blog/*') && !Request::is('admin/blogcategory') && !Request::is('admin/blogcategory/*'))
