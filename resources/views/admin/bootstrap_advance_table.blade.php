            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table" id="table1" data-show-toggle="true" data-toggle="table" data-sort-order="asc" data-pagination="true" data-search="true" data-card-view="true">
                            <thead>
                            <tr>
...
<script src="{{ asset('assets/js/custom_js/bs-advtable.js') }}"></script>
<script>
