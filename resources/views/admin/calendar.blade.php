...
@section('header_styles')
    ...
    <link href="{{ asset('assets/css/custom_css/calendar_custom.css') }}" rel="stylesheet" type="text/css" />
    @stop
...
@section('footer_scripts')
    <script src="{{ asset('assets/vendors/moment/js/moment.min.js') }}"  type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/js/custom_js/calendar.js') }}" type="text/javascript"></script>
        @stop