...
@stop
    <!-- page level css-->
    <link href="{{ asset('assets/vendors/jqvmap/css/jqvmap.css') }}" mediaff="screen" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/custom_css/custom_map.css') }}" mediaff="screen" rel="stylesheet" type="text/css" />
