                                                ...
                                                <select class="form-control " title="Select group..." name="group" id="group" required="">
                                                    ...
                                                    @foreach($roles as $role)
                                                        <option value="{{ $role->id }}"
                                                                @if($role->id == old('group')) selected="selected" @endif >{{ $role->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input id="activate" name="activate" type="checkbox"
                                                       ...
                                                       @if(old('activate')) checked="checked" @endif >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="google_plus"
                                                           name="google_plus" class="form-control"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="skype" name="skype"
                                                           class="form-control" value="{!! old('skype') !!}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="flickr" name="flickr"
                                                           class="form-control" value="{!! old('flickr') !!}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="youtube" name="youtube"
                                                           class="form-control" value="{!! old('youtube') !!}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
