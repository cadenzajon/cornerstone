                ...
                <div class="tab-content nopadding noborder">
                        ...
                        <div class="activity">
                                    ...
                                    <ul class="uploadphoto-list">
                                        <li>
                                            <a href="{{ asset('assets/img/authors/avatar1.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('assets/img/authors/avatar1.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('assets/img/authors/avatar4.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('assets/img/authors/avatar4.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('assets/img/authors/avatar5.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('assets/img/authors/avatar5.jpg') }}" class="thumbnail img-responsive" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="imgs-profile">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="mb20"></div>
                                    <a href="{{ asset('assets/img/authors/avatar.jpg') }}" data-rel="prettyPhoto" class="img-single img-responsive" style="width:300px;">
                                        <img src="{{ asset('assets/img/authors/avatar.jpg') }}" class="thumbnail img-responsive" alt="" width="200px" height="200px"></a>
                                </div>
                            </div>
                            <!-- media -->
                    ...
                    <div class="tab-pane" id="followers">
                        <div class="follower-list">
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle" src="http://placehold.it/100x100" alt="image" />
                                </a>
                                <div class="media-body">
                        ...
                        <div class="events">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object thumbnail" src="http://placehold.it/100x100" alt="image" />
                                        </a>
                                        <div class="media-body">
