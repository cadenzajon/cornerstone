...
@section('header_styles')
    <link href="{{ asset('assets/css/custom_css/form2.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/css/custom_css/form3.css') }}" rel="stylesheet" type="text/css"/>
    @stop
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form id="form-validation" method="post" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="val-username" name="firstName" class="form-control" placeholder="Choose a nice username.."></div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <label class="padding7" for="terms" >
                                                    <input type="checkbox" id="terms" name="terms">&nbsp;I agree</label>
                                            </div>
                                        </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" data-validate="length" data-length="5">
                                                <textarea class="form-control" name="validate-length" id="validate-length" placeholder="Minimum length 5 characters" required></textarea>
                                                <span class="input-group-addon danger">
                                                    <span class="glyphicon glyphicon-remove"></span>
                                                </span>
                                            </div>
                        ...
                        <div class="col-md-6">
                                        ...
                                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form" id="form-validation1" action="form_validations.html" method="post">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form action="#" method="post" name="frmOnline" onsubmit="return Validation()" enctype="multipart/form-data">
                                        {!! Form::token() !!}
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="form-group">
...
@section('footer_scripts')
        <script src="{{ asset('assets/js/custom_js/form1.js') }}" type="text/javascript" ></script>
        <script src="{{ asset('assets/js/custom_js/form2.js') }}" type="text/javascript" ></script>
        <script src="{{ asset('assets/js/custom_js/form3.js') }}" type="text/javascript" ></script>
        <script src="{{ asset('assets/vendors/bootstrapvalidator/js/bootstrapValidator.min.js') }}" type="text/javascript" ></script>
        <script src="{{ asset('assets/js/custom_js/form_validations.js') }}" type="text/javascript" ></script>
        @stop