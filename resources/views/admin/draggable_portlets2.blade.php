...
<![endif]-->
<!--page level css -->
<link href="{{ asset('assets/css/custom_css/sortable_list.css')}}" rel="stylesheet" type="text/css">
...
{{--<script src="{{ asset('assets/vendors/Sortable/js/app.js')}}" type="text/javascript"></script>--}}
<script src="{{ asset('assets/js/custom_js/sortable_list.js') }}" type="text/javascript"></script>
