...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/bootstrap-tagsinput/css/app.css') }}" rel="stylesheet">
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/typeahead.js/js/typeahead.bundle.min.js') }}"></script>
    <script src="{{ asset('assets/vendors/typeahead.js/js/bloodhound.min.js') }}"></script>
    <script src="{{ asset('assets/js/tags_data/app_bs3.js') }}"></script>
@stop