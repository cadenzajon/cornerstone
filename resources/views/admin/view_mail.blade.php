                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body ">
                                    ...
                                    <div class="mail-header row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="compose-btn pull-right">
                                                ...
                                                <button class="btn btn-sm tooltips" data-original-title="Trash" data-toggle="tooltip" data-placement="top" title="">
                                                    <i class="fa fa-trash-o"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mail-sender">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <img src=" {{ asset('assets/img/authors/avatar1.jpg') }}" alt="icon" class="img-circle" width="38">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="atch-thumb" href="#">
                                                    <img src="{{ asset('assets/img/flaticons/Christmas-15.png') }}" alt="icon"></a>
                                            ...
                                            <li>
                                                <a class="atch-thumb" href="#">
                                                <img src="{{ asset('assets/img/flaticons/Valentine_day-09.png') }}" alt="img"></a>
                                    ...
                                    <div class="compose-btn pull-left">
                                        <a href="mail_compose" class="btn btn-sm btn-primary" >
                                            <i class="fa fa-reply"></i>
                                            Reply
                                        </a>
