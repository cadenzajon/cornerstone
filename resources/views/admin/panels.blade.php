...
@section('header_styles')
    <link href="{{ asset('assets/vendors/flippant/css/flippant.css') }}" rel="stylesheet" type="text/css">
...
@section('footer_scripts')
        <script type="text/javascript" src="{{ asset('assets/vendors/flippant/js/flippant.js') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/js/custom_js/panel-flip.js') }}"></script>
        @stop