...
@section('header_styles')
    <link href="{{ asset('assets/css/custom_css/flot_charts.css') }}" rel="stylesheet" type="text/css">
    @stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/flotchart/js/jquery.flot.categories.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('assets/js/custom_js/flot_charts.js') }}" type="text/javascript" ></script>
    @stop