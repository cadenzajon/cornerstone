...
@section('header_styles')
    <link href="{{ asset('assets/vendors/iCheck/css/minimal/green.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/css/custom_css/mail.css') }}" rel="stylesheet" type="text/css"/>
@stop
        ...
        <div class="row">
            ...
            <div class="col-lg-9 table-bordered">
                ...
                <div class="mail-box-header">
                    ...
                    <form method="get" action="{{ route('dashboard') }}" class="pull-right mail-search">
                    ...
                    <table class="table" id="inbox-check">
                        ...
                        <tr data-messageid="1" class="unread">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="2" class="unread">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar1.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="3">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar7.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="4">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar4.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="5">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar2.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="6">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar3.jpg') }}" width="27" height="27"
                        ...
                        <tr data-messageid="9">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="">
                                    <img src=" {{ asset('assets/img/authors/avatar5.jpg') }}" width="27" height="27"
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/custom_js/mail.js') }}" type="text/javascript"></script>
@stop