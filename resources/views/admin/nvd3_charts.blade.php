...
@section('header_styles')
    <link href="{{ asset('assets/vendors/nvd3/css/nv.d3.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/custom_css/nvd3_charts.css') }}" rel="stylesheet" type="text/css">
    @stop
...
@section('footer_scripts')
    <script src="{{ asset('assets/vendors/d3/js/d3.js') }}" ></script>
    <script src="{{ asset('assets/vendors/nvd3/js/nv.d3.js') }}"></script>
    <script src="{{ asset('assets/js/custom_js/stream_layers.js') }}"></script>
    <script src="{{ asset('assets/js/custom_js/nvd3_charts.js') }}"></script>
@stop