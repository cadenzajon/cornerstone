...
@section('header_styles')
    <link href="{{ asset('assets/vendors/Buttons/css/buttons.css') }}" rel="stylesheet">
    <link href="{{asset('assets/vendors/hover/hover.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/css/custom_css/advbuttons.css') }}" rel="stylesheet">
    @stop
                                    ...
                                    <div class="flatbuttons">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#" class="button btn-success hvr-wobble-to-top-right">button</a>
                                                </li>
                                                <li>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-xs-6 col-sm-6">
                                            ...
                                            <button type="button" class="btn btn-labeled btn-default">
                                                Right
                                                <span class="btn-label" style="left: 14px;">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/custom_js/button_main.js')}}"></script>
    <script src="{{ asset('assets/vendors/Buttons/js/buttons.js')}}"></script>
        @stop