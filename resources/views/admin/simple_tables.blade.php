                                    ...
                                    <table id="mytable" class="table table-bordred table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <button class="btn btn-green btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" data-placement="top" rel="tooltip">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </button>
                                                    </p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <button class="btn btn-purple btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" data-placement="top" rel="tooltip">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </button>
                                                    </p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <button class="btn btn-yellow btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" data-placement="top" rel="tooltip">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </button>
                                                    </p>
                                                </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <textarea rows="2" class="form-control" placeholder="2021 K Street Northwest #300, Washington, DC 20006"></textarea>
                                </div>
                            </div>
...
@section('footer_scripts')
  <script src="{{ asset('assets/js/custom_js/simple-table.js') }}" type="text/javascript"></script>
    @stop