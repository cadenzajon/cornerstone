...
@section('header_styles')
    ...
    <!--select css-->
    <link href="{{ asset('assets/vendors/select2/css/select2.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/vendors/select2/css/select2-bootstrap.css') }}" rel="stylesheet" type="text/css"/>
    <!--clock face css-->
    <link href="{{ asset('assets/vendors/iCheck/css/all.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/vendors/clockpicker/css/bootstrap-clockpicker.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('assets/vendors/bootstrap-fileinput/css/fileinput.css') }}" media="all" rel="stylesheet" type="text/css" />
<link href="{{ asset('assets/css/custom_css/form_elements.css') }}" rel="stylesheet">
    @stop
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="c1" value=""></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="checkbox-inline" id="checkbox_margl">
                                                    <input type="checkbox" id="inlineCheckbox1" value="option1">Inline checkbox 1</label>
                                                <label class="checkbox-inline" id="checkbox_margl">
                                                    <input type="checkbox" id="inlineCheckbox2" value="option2">Inline checkbox 2</label>
                                                <label class="checkbox-inline" id="checkbox_margl">
                                                    <input type="checkbox" id="inlineCheckbox3" value="option3">Inline checkbox 3</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group mar-20">
                                            ...
                                            <div class="input-group select2-bootstrap-append">
                                                ...
                                                <div class="input-group-btn">
                                                    ...
                                                    <button class="btn btn-success" type="button" data-select2-open="multi-prepend">State</button>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mar-20">
                                            ...
                                            <div class="input-group select2-bootstrap-prepend">
                                                <div class="input-group-btn">
                                                    <button class="btn btn-danger" type="button" data-select2-open="multi-prepend">State</button>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/jquery.inputmask/inputmask/inputmask.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/jquery.inputmask/inputmask/inputmask.date.extensions.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/jquery.inputmask/inputmask/inputmask.extensions.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/jquery.inputmask/inputmask/jquery.inputmask.js') }}"  type="text/javascript"></script>
        <!-- date-range-picker -->
        ...
        <script src="{{ asset('assets/vendors/clockpicker/js/bootstrap-clockpicker.js') }}"></script>
        <script src="{{ asset('assets/js/custom_js/form_elements.js') }}"></script>
        @stop