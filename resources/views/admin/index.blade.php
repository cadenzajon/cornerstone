                                    ...
                                    <div class="col-md-12 col-lg-9">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-3 text-center">
                                                <img src="{{ asset('assets/img/flags/au.png') }}" alt="img">
                                                <h5>
                                            ...
                                            <div class="col-xs-6 col-sm-3 text-center">
                                                <div>
                                                    <img src="{{ asset('assets/img/flags/ca.png') }}" alt="img">
                                                    <h5>
                                            ...
                                            <div class="col-xs-6 col-sm-3 text-center">
                                                <div>
                                                    <img src="{{ asset('assets/img/flags/uk.png') }}" alt="img">
                                                    <h5>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/splinecharts/jquery.flot.spline.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/flot.tooltip/js/jquery.flot.tooltip.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/bower-jvectormap/js/jquery-jvectormap-1.2.2.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/bower-jvectormap/js/jquery-jvectormap-world-mill-en.js') }}" type="text/javascript"></script>
