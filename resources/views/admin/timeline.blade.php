...
@section('header_styles')
    <link href="{{ asset('assets/vendors/vertical-timeline/css/style.css') }}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/css/custom_css/timeline.css') }}" type="text/css">
    @stop
            ...
            <section id="cd-timeline" class="cd-container">
               <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-movie">
                         <img src=" {{ asset('assets/img/flaticons/scenic-icons/E-Commerce/Ecommerce-12.png') }}" alt="Picture" width="60" height="60">
                        </div>
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-movie">
                        <img src=" {{ asset('assets/img/flaticons/scenic-icons/DIsasters/Disasters-01.png') }}" alt="Picture" width="60" height="60">
                        </div>
                    <!-- cd-timeline-img -->
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-picture">
                       <img src=" {{ asset('assets/img/flaticons/Christmas-15.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-location">
                       <img src=" {{ asset('assets/img/flaticons/social-media-14.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <a href="#" class="btn btn-md btn-primary route">Read more</a>
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-location">
                        <img src=" {{ asset('assets/img/flaticons/social-media-11.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-movie">
                       <img src=" {{ asset('assets/img/flaticons/Graphic-Design-Tools-06.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-location">
                        <img src=" {{ asset('assets/img/flaticons/Multimedia-20.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
                ...
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img cd-movie">
                       <img src=" {{ asset('assets/img/flaticons/social-media-27.png') }}" alt="Picture" width="60" height="60"></div>
                    <!-- cd-timeline-img -->
