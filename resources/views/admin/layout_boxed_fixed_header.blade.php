@extends('admin/layouts/boxed_fixed_header')
...
&lt;/body&gt;</code></pre>
                    ...
                    <div class="col-lg-12">
                        ...
                        <p  class="text-justify">
                            <img src="http://placehold.it/900x150" alt="" class="img-responsive pull-left mrm">
