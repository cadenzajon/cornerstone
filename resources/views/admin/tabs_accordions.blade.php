...
{{-- Page title --}}
@section('title')Tabs &amp; Accordions @parent

@stop
    {{-- page level styles --}}
@section('header_styles')
    <link href="{{ asset('assets/css/custom_css/tab.css') }}" rel="stylesheet" type="text/css">
    @stop
                                ...
                                <div class="row">
                                    <div class="po-markup">
                                        ...
                                        <div class="po-content hidden">
                                            <div class="po-title">
                                                <img src=" {{ asset('assets/img/football.jpg') }}" alt="football" width="20" height="20" />
                                                Foot Ball world cup
                                            </div>
                                            <!-- ./po-title -->
                                            <div class="po-body">
...
@section('footer_scripts')
  <script src="{{ asset('assets/js/custom_js/tabs_accordions.js') }}" type="text/javascript"></script>
    @stop