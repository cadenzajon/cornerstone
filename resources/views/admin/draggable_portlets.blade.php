...
@section('header_styles')
    <link href="{{ asset('assets/css/custom_css/portlet.css') }}" rel="stylesheet" type="text/css"/>
    @stop
...
<script src="{{ asset('assets/js/custom_js/portlets.js') }}" type="text/javascript"></script>
@stop                    