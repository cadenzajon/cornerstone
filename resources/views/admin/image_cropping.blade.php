...
<!--page level css -->
<link href="{{ asset('assets/vendors/cropper/css/cropper.min.css')}}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/css/custom_css/crop.css')}}" rel="stylesheet" type="text/css">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="img-container">
                                        <img id="image" src="{{asset('assets/img/gallery/full/21.jpg')}}" alt="Picture">
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <ul class="list-unstyled margin-none">
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar1.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                ...
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                        <i class="fa fa-circle text-xs text-primary"></i>
                                        Rolando
                                    </a>
                                </li>
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar2.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                        <i class="fa fa-circle text-xs text-primary"></i>
                                        Marlee
                                    </a>
                                </li>
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar3.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                ...
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar4.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                ...
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar5.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                ...
                                <li class="rightsidebar-contact-wrapper">
                                    <a class="rightsidebar-contact" href="#">
                                        <img src="{{asset('assets/img/authors/avatar7.jpg')}}" alt="image" height="20" width="20" class="img-circle pull-right">
                                        <i class="fa fa-circle text-xs text-muted"></i>
                                        Charlene
                                    </a>
                                </li>
...
<script src="{{ asset('assets/js/custom_js/crop.js')}}" type="text/javascript"></script>
