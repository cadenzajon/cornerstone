...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/bootstrap-touchspin/css/jquery.bootstrap-touchspin.css') }}" rel="stylesheet" type="text/css" />
                                    ...
                                    <div class="form-group col-md-6 col-xs-12">
                                        ...
                                        <div class="input-group  col-md-8">
                                            <div class="btn-group">
                                                ...
                                                <button id="example35-enable" class="btn btn-default" style="margin-top: 3px;">Enable</button>
                                                <button id="example35-disable" class="btn btn-default" style="margin-top: 3px;">Disable</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.form group --> </div>
...
@section('footer_scripts')
    <script src="{{ asset('assets/vendors/moment/js/moment.min.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/vendors/clockpicker/js/bootstrap-clockpicker.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/vendors/bootstrap-touchspin/js/jquery.bootstrap-touchspin.js') }}" type="text/javascript"></script>
