...
{{-- Page title --}}
@section('title')Font Icons @parent

@stop
    {{-- page level styles --}}
@section('header_styles')
    <!-- font Awesome -->
    <link href="{{ asset('assets/css/custom_css/icon.css') }}" rel="stylesheet" type="text/css">
    @stop
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="fa-icons">
                                                <section>
                                                    ...
                                                    <div class=" col-md-4 list-group">
                                                        ...
                                                        <a class="list-group-item" href="#">
                                                            ...
                                                            <span class="text-primary">&nbsp; Dotted Circle</span>
                                                        </a>
                                                        <a class="list-group-item" href="#">
                                                            <i class="fa fa-circle fa-fw fa-spin text-danger"></i>
                                                            <span class="text-danger">&nbsp; Solid Circle</span>
                                                        </a>
                                                        <a class="list-group-item" href="#">
                                                            <i class="fa fa-refresh fa-fw fa-spin text-primary"></i>
                                                            <span class="text-primary">&nbsp; Arrowed Circle</span>
                                                        </a>
                                                        <a class="list-group-item" href="#">
                                                            <i class="fa fa-cog fa-fw fa-spin text-danger"></i>
                                                            <span class="text-danger">&nbsp; Star Circle</span>
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class=" col-md-4 list-group">
                                                        ...
                                                        <a class="list-group-item" href="#">
                                                            ...
                                                            <span class="text-danger">&nbsp; Bi-cycle</span>
                                                        </a>
                                                        <a class="list-group-item" href="#">
                                                        ...
                                                        <a class="list-group-item" href="#">
                                                            ...
                                                            <span class="text-danger">&nbsp; Airplane</span>
                                                        </a>
                                                    </div>

                                                    <div class=" col-md-4 list-group">
                                                        <h4>Boostrap 3 Examples</h4>
                                                    ...
                                                    <div class="input-group right-padding">
                                                        <span class="input-group-addon">
                                                ...
                                                <div class="tab-pane" id="glyphicons">
                                                    <h3>Glyphicons provided by Bootstrap</h3>
