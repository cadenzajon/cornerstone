...
<script src="{{ asset('assets/vendors/bootstrap-table/js/bootstrap-table-toolbar.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('assets/vendors/bootstrap-table/js/bootstrap-table-editable.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('assets/vendors/x-editable/js/bootstrap-editable.js')}}" type="text/javascript"></script>
<script src="{{ asset('assets/vendors/bootstrap-table/js/bootstrap-table-export.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('assets/vendors/bootstrap-table/js/tableExport.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('assets/js/custom_js/bs-editable.js')}}" type="text/javascript"></script>
@stop